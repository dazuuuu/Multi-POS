...
use App\Backend\Modules\Industry\BarLiquor\NightReports\Models\BartenderSalesModel;

class BartenderSalesService extends BaseModuleService
{
    private BartenderSalesModel $model;

    public function __construct()
    {
        parent::__construct('bar_liquor', 'bartender_sales');
        $this->model = new BartenderSalesModel();
    }
