...
use App\Backend\Modules\Industry\BarLiquor\BarOperations\Models\TableServiceModel;

class TableServiceService extends BaseModuleService
{
    private TableServiceModel $model;

    public function __construct()
    {
        parent::__construct('bar_liquor', 'table_service');
        $this->model = new TableServiceModel();
    }
