...
use App\Backend\Modules\Industry\BarLiquor\BarOperations\Models\MixTrackingModel;

class MixTrackingService extends BaseModuleService
{
    private MixTrackingModel $model;

    public function __construct()
    {
        parent::__construct('bar_liquor', 'mix_tracking');
        $this->model = new MixTrackingModel();
    }
