...
use App\Backend\Modules\Industry\BarLiquor\BarOperations\Models\CocktailRecipesModel;

class CocktailRecipesService extends BaseModuleService
{
    private CocktailRecipesModel $model;

    public function __construct()
    {
        parent::__construct('bar_liquor', 'cocktail_recipes');
        $this->model = new CocktailRecipesModel();
    }
