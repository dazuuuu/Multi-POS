...
use App\Backend\Modules\Industry\BarLiquor\BarOperations\Models\BottleTrackingModel;

class BottleTrackingService extends BaseModuleService
{
    private BottleTrackingModel $model;

    public function __construct()
    {
        parent::__construct('bar_liquor', 'bottle_tracking');
        $this->model = new BottleTrackingModel();
    }
