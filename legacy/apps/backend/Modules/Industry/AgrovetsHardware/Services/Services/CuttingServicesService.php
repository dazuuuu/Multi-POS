...
use App\Backend\Modules\Industry\AgrovetsHardware\Services\Models\CuttingServicesModel;

class CuttingServicesService extends BaseModuleService
{
    private CuttingServicesModel $model;

    public function __construct()
    {
        parent::__construct('agrovets_hardware', 'cutting_services');
        $this->model = new CuttingServicesModel();
    }
