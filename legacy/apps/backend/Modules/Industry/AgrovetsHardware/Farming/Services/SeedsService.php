...
use App\Backend\Modules\Industry\AgrovetsHardware\Farming\Models\SeedsModel;

class SeedsService extends BaseModuleService
{
    private SeedsModel $model;

    public function __construct()
    {
        parent::__construct('agrovets_hardware', 'seeds');
        $this->model = new SeedsModel();
    }
