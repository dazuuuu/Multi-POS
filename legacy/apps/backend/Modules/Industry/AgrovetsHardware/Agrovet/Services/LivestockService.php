...
use App\Backend\Modules\Industry\AgrovetsHardware\Agrovet\Models\LivestockModel;

class LivestockService extends BaseModuleService
{
    private LivestockModel $model;

    public function __construct()
    {
        parent::__construct('agrovets_hardware', 'livestock');
