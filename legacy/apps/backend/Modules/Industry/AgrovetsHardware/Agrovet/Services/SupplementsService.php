...
use App\Backend\Modules\Industry\AgrovetsHardware\Agrovet\Models\SupplementsModel;

class SupplementsService extends BaseModuleService
{
    private SupplementsModel $model;

    public function __construct()
    {
        parent::__construct('agrovets_hardware', 'supplements');
        $this->model = new SupplementsModel();
    }
