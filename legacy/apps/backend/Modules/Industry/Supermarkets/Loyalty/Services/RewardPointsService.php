...
use App\Backend\Modules\Industry\Supermarkets\Loyalty\Models\RewardPointsModel;

class RewardPointsService extends BaseModuleService
{
    private RewardPointsModel $model;

    public function __construct()
    {
        parent::__construct('supermarkets', 'reward_points');
