...
use App\Backend\Modules\Industry\WholesaleRetail\Orders\Models\QuotationsModel;

class QuotationsService extends BaseModuleService
{
    private QuotationsModel $model;

    public function __construct()
    {
        parent::__construct('wholesale_retail', 'quotations');
        $this->model = new QuotationsModel();
    }
