...
use App\Backend\Modules\Industry\WholesaleRetail\Credit\Models\InstallmentsModel;

class InstallmentsService extends BaseModuleService
{
    private InstallmentsModel $model;

    public function __construct()
    {
        parent::__construct('wholesale_retail', 'installments');
        $this->model = new InstallmentsModel();
    }
