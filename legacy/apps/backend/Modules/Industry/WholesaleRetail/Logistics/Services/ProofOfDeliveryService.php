...
use App\Backend\Modules\Industry\WholesaleRetail\Logistics\Models\ProofOfDeliveryModel;

class ProofOfDeliveryService extends BaseModuleService
{
    private ProofOfDeliveryModel $model;

    public function __construct()
    {
        parent::__construct('wholesale_retail', 'proof_of_delivery');
        $this->model = new ProofOfDeliveryModel();
    }
