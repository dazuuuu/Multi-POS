...
use App\Backend\Modules\Industry\WholesaleRetail\Logistics\Models\DispatchModel;

class DispatchService extends BaseModuleService
{
    private DispatchModel $model;

    public function __construct()
    {
        parent::__construct('wholesale_retail', 'dispatch');
