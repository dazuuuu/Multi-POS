...
use App\Backend\Modules\Industry\WholesaleRetail\Logistics\Models\DeliveryRoutesModel;

class DeliveryRoutesService extends BaseModuleService
{
    private DeliveryRoutesModel $model;

    public function __construct()
    {
        parent::__construct('wholesale_retail', 'delivery_routes');
        $this->model = new DeliveryRoutesModel();
    }
