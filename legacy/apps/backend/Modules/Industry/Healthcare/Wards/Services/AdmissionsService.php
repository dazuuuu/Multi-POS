...
use App\Backend\Modules\Industry\Healthcare\Wards\Models\AdmissionsModel;

class AdmissionsService extends BaseModuleService
{
    private AdmissionsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'admissions');
        $this->model = new AdmissionsModel();
    }
