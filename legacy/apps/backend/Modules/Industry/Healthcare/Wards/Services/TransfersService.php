...
use App\Backend\Modules\Industry\Healthcare\Wards\Models\TransfersModel;

class TransfersService extends BaseModuleService
{
    private TransfersModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'transfers');
