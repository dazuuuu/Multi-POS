...
use App\Backend\Modules\Industry\Healthcare\Dental\Models\XrayRecordsModel;

class XrayRecordsService extends BaseModuleService
{
    private XrayRecordsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'xray_records');
        $this->model = new XrayRecordsModel();
    }
