...
use App\Backend\Modules\Industry\Healthcare\Maternity\Models\ImmunizationSchedulesModel;

class ImmunizationSchedulesService extends BaseModuleService
{
    private ImmunizationSchedulesModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'immunization_schedules');
        $this->model = new ImmunizationSchedulesModel();
    }
