...
use App\Backend\Modules\Industry\Healthcare\Maternity\Models\AncVisitsModel;

class AncVisitsService extends BaseModuleService
{
    private AncVisitsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'anc_visits');
        $this->model = new AncVisitsModel();
    }
