...
use App\Backend\Modules\Industry\Healthcare\Maternity\Models\PostnatalCareModel;

class PostnatalCareService extends BaseModuleService
{
    private PostnatalCareModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'postnatal_care');
        $this->model = new PostnatalCareModel();
    }
