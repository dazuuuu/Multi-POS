...
use App\Backend\Modules\Industry\Healthcare\Maternity\Models\DeliveryRecordsModel;

class DeliveryRecordsService extends BaseModuleService
{
    private DeliveryRecordsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'delivery_records');
        $this->model = new DeliveryRecordsModel();
    }
