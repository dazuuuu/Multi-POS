...
use App\Backend\Modules\Industry\Healthcare\Reception\Models\PatientRegistrationModel;

class PatientRegistrationService extends BaseModuleService
{
    private PatientRegistrationModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'patient_registration');
        $this->model = new PatientRegistrationModel();
    }
