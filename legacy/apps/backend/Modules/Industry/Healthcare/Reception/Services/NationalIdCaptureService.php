...
use App\Backend\Modules\Industry\Healthcare\Reception\Models\NationalIdCaptureModel;

class NationalIdCaptureService extends BaseModuleService
{
    private NationalIdCaptureModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'national_id_capture');
        $this->model = new NationalIdCaptureModel();
    }
