...
use App\Backend\Modules\Industry\Healthcare\Reception\Models\PatientCardsModel;

class PatientCardsService extends BaseModuleService
{
    private PatientCardsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'patient_cards');
        $this->model = new PatientCardsModel();
    }
