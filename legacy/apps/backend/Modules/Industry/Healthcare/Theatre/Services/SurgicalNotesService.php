...
use App\Backend\Modules\Industry\Healthcare\Theatre\Models\SurgicalNotesModel;

class SurgicalNotesService extends BaseModuleService
{
    private SurgicalNotesModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'surgical_notes');
        $this->model = new SurgicalNotesModel();
    }
