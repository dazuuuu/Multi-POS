...
use App\Backend\Modules\Industry\Healthcare\Theatre\Models\ConsentFormsModel;

class ConsentFormsService extends BaseModuleService
{
    private ConsentFormsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'consent_forms');
        $this->model = new ConsentFormsModel();
    }
