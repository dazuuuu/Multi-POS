...
use App\Backend\Modules\Industry\Healthcare\Theatre\Models\SurgerySchedulingModel;

class SurgerySchedulingService extends BaseModuleService
{
    private SurgerySchedulingModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'surgery_scheduling');
        $this->model = new SurgerySchedulingModel();
    }
