...
use App\Backend\Modules\Industry\Healthcare\Doctor\Models\FollowUpSchedulingModel;

class FollowUpSchedulingService extends BaseModuleService
{
    private FollowUpSchedulingModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'follow_up_scheduling');
        $this->model = new FollowUpSchedulingModel();
    }
