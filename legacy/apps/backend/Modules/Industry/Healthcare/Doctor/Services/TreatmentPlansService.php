...
use App\Backend\Modules\Industry\Healthcare\Doctor\Models\TreatmentPlansModel;

class TreatmentPlansService extends BaseModuleService
{
    private TreatmentPlansModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'treatment_plans');
        $this->model = new TreatmentPlansModel();
    }
