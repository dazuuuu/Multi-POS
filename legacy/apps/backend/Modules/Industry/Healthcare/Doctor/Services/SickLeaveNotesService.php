...
use App\Backend\Modules\Industry\Healthcare\Doctor\Models\SickLeaveNotesModel;

class SickLeaveNotesService extends BaseModuleService
{
    private SickLeaveNotesModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'sick_leave_notes');
        $this->model = new SickLeaveNotesModel();
    }
