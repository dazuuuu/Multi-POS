...
use App\Backend\Modules\Industry\Healthcare\Doctor\Models\DiagnosisIcdModel;

class DiagnosisIcdService extends BaseModuleService
{
    private DiagnosisIcdModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'diagnosis_icd');
        $this->model = new DiagnosisIcdModel();
    }
