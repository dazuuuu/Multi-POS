...
use App\Backend\Modules\Industry\Healthcare\Emr\Models\ClinicalNotesModel;

class ClinicalNotesService extends BaseModuleService
{
    private ClinicalNotesModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'clinical_notes');
        $this->model = new ClinicalNotesModel();
    }
