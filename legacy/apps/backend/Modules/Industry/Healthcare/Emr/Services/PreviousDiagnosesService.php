...
use App\Backend\Modules\Industry\Healthcare\Emr\Models\PreviousDiagnosesModel;

class PreviousDiagnosesService extends BaseModuleService
{
    private PreviousDiagnosesModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'previous_diagnoses');
        $this->model = new PreviousDiagnosesModel();
    }
