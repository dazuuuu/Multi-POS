...
use App\Backend\Modules\Industry\Healthcare\Emr\Models\AllergiesModel;

class AllergiesService extends BaseModuleService
{
    private AllergiesModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'allergies');
        $this->model = new AllergiesModel();
    }
