...
use App\Backend\Modules\Industry\Healthcare\Emr\Models\PatientDemographicsModel;

class PatientDemographicsService extends BaseModuleService
{
    private PatientDemographicsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'patient_demographics');
        $this->model = new PatientDemographicsModel();
    }
