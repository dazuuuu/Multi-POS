...
use App\Backend\Modules\Industry\Healthcare\Insurance\Models\InsuranceCompaniesModel;

class InsuranceCompaniesService extends BaseModuleService
{
    private InsuranceCompaniesModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'insurance_companies');
        $this->model = new InsuranceCompaniesModel();
    }
