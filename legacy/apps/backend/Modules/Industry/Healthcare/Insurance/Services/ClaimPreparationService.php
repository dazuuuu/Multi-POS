...
use App\Backend\Modules\Industry\Healthcare\Insurance\Models\ClaimPreparationModel;

class ClaimPreparationService extends BaseModuleService
{
    private ClaimPreparationModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'claim_preparation');
        $this->model = new ClaimPreparationModel();
    }
