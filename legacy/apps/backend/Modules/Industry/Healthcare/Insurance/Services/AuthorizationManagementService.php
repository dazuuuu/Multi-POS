...
use App\Backend\Modules\Industry\Healthcare\Insurance\Models\AuthorizationManagementModel;

class AuthorizationManagementService extends BaseModuleService
{
    private AuthorizationManagementModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'authorization_management');
        $this->model = new AuthorizationManagementModel();
    }
