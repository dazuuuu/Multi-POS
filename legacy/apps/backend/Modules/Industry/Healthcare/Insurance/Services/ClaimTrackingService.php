...
use App\Backend\Modules\Industry\Healthcare\Insurance\Models\ClaimTrackingModel;

class ClaimTrackingService extends BaseModuleService
{
    private ClaimTrackingModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'claim_tracking');
        $this->model = new ClaimTrackingModel();
    }
