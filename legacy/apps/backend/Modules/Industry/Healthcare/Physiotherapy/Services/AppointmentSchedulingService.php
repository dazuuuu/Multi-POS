...
use App\Backend\Modules\Industry\Healthcare\Physiotherapy\Models\AppointmentSchedulingModel;

class AppointmentSchedulingService extends BaseModuleService
{
    private AppointmentSchedulingModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'appointment_scheduling');
        $this->model = new AppointmentSchedulingModel();
    }
