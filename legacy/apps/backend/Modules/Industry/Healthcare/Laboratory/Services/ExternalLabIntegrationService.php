...
use App\Backend\Modules\Industry\Healthcare\Laboratory\Models\ExternalLabIntegrationModel;

class ExternalLabIntegrationService extends BaseModuleService
{
    private ExternalLabIntegrationModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'external_lab_integration');
        $this->model = new ExternalLabIntegrationModel();
    }
