...
use App\Backend\Modules\Industry\Healthcare\Laboratory\Models\ResultsEntryModel;

class ResultsEntryService extends BaseModuleService
{
    private ResultsEntryModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'results_entry');
        $this->model = new ResultsEntryModel();
    }
