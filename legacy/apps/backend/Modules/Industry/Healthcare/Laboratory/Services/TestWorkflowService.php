...
use App\Backend\Modules\Industry\Healthcare\Laboratory\Models\TestWorkflowModel;

class TestWorkflowService extends BaseModuleService
{
    private TestWorkflowModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'test_workflow');
        $this->model = new TestWorkflowModel();
    }
