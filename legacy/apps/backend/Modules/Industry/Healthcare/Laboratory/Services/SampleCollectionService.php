...
use App\Backend\Modules\Industry\Healthcare\Laboratory\Models\SampleCollectionModel;

class SampleCollectionService extends BaseModuleService
{
    private SampleCollectionModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'sample_collection');
        $this->model = new SampleCollectionModel();
    }
