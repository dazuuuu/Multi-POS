...
use App\Backend\Modules\Industry\Healthcare\Laboratory\Models\LabRequestsModel;

class LabRequestsService extends BaseModuleService
{
    private LabRequestsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'lab_requests');
        $this->model = new LabRequestsModel();
    }
