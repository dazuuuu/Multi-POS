...
use App\Backend\Modules\Industry\Healthcare\Laboratory\Models\PrintableReportsModel;

class PrintableReportsService extends BaseModuleService
{
    private PrintableReportsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'printable_reports');
        $this->model = new PrintableReportsModel();
    }
