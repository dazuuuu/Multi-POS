...
use App\Backend\Modules\Industry\Healthcare\Nursing\Models\VitalSignsModel;

class VitalSignsService extends BaseModuleService
{
    private VitalSignsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'vital_signs');
