...
use App\Backend\Modules\Industry\Healthcare\Nursing\Models\MedicationAdministrationModel;

class MedicationAdministrationService extends BaseModuleService
{
    private MedicationAdministrationModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'medication_administration');
        $this->model = new MedicationAdministrationModel();
    }
