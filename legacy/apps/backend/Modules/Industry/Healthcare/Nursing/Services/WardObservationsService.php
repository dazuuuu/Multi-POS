...
use App\Backend\Modules\Industry\Healthcare\Nursing\Models\WardObservationsModel;

class WardObservationsService extends BaseModuleService
{
    private WardObservationsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'ward_observations');
        $this->model = new WardObservationsModel();
    }
