...
use App\Backend\Modules\Industry\Healthcare\Billing\Models\InsuranceBillingModel;

class InsuranceBillingService extends BaseModuleService
{
    private InsuranceBillingModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'insurance_billing');
        $this->model = new InsuranceBillingModel();
    }
