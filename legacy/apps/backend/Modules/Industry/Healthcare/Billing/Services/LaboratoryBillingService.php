...
use App\Backend\Modules\Industry\Healthcare\Billing\Models\LaboratoryBillingModel;

class LaboratoryBillingService extends BaseModuleService
{
    private LaboratoryBillingModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'laboratory_billing');
        $this->model = new LaboratoryBillingModel();
    }
