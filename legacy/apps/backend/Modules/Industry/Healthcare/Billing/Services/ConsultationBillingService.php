...
use App\Backend\Modules\Industry\Healthcare\Billing\Models\ConsultationBillingModel;

class ConsultationBillingService extends BaseModuleService
{
    private ConsultationBillingModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'consultation_billing');
        $this->model = new ConsultationBillingModel();
    }
