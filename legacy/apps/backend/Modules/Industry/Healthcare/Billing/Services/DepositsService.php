...
use App\Backend\Modules\Industry\Healthcare\Billing\Models\DepositsModel;

class DepositsService extends BaseModuleService
{
    private DepositsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'deposits');
