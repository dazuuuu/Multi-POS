...
use App\Backend\Modules\Industry\RestaurantHotels\Hotels\Models\MiniBarModel;

class MiniBarService extends BaseModuleService
{
    private MiniBarModel $model;

    public function __construct()
    {
        parent::__construct('restaurant_hotels', 'mini_bar');
        $this->model = new MiniBarModel();
    }
