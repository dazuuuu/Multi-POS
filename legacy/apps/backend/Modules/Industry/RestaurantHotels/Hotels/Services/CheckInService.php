...
use App\Backend\Modules\Industry\RestaurantHotels\Hotels\Models\CheckInModel;

class CheckInService extends BaseModuleService
{
    private CheckInModel $model;

    public function __construct()
    {
        parent::__construct('restaurant_hotels', 'check_in');
