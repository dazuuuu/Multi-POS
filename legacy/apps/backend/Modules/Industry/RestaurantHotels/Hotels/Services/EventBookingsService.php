...
use App\Backend\Modules\Industry\RestaurantHotels\Hotels\Models\EventBookingsModel;

class EventBookingsService extends BaseModuleService
{
    private EventBookingsModel $model;

    public function __construct()
    {
        parent::__construct('restaurant_hotels', 'event_bookings');
        $this->model = new EventBookingsModel();
    }
