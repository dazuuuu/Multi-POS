...
use App\Backend\Modules\Industry\RestaurantHotels\Hotels\Models\CheckOutModel;

class CheckOutService extends BaseModuleService
{
    private CheckOutModel $model;

    public function __construct()
    {
        parent::__construct('restaurant_hotels', 'check_out');
