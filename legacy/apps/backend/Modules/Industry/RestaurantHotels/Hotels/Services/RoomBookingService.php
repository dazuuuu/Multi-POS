...
use App\Backend\Modules\Industry\RestaurantHotels\Hotels\Models\RoomBookingModel;

class RoomBookingService extends BaseModuleService
{
    private RoomBookingModel $model;

    public function __construct()
    {
        parent::__construct('restaurant_hotels', 'room_booking');
        $this->model = new RoomBookingModel();
    }
