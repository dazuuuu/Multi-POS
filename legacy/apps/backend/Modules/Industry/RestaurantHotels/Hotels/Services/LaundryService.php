...
use App\Backend\Modules\Industry\RestaurantHotels\Hotels\Models\LaundryModel;

class LaundryService extends BaseModuleService
{
    private LaundryModel $model;

    public function __construct()
    {
        parent::__construct('restaurant_hotels', 'laundry');
