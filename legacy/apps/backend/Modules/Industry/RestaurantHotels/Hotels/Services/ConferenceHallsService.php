...
use App\Backend\Modules\Industry\RestaurantHotels\Hotels\Models\ConferenceHallsModel;

class ConferenceHallsService extends BaseModuleService
{
    private ConferenceHallsModel $model;

    public function __construct()
    {
        parent::__construct('restaurant_hotels', 'conference_halls');
        $this->model = new ConferenceHallsModel();
    }
