...
use App\Backend\Modules\Industry\RestaurantHotels\Restaurant\Models\AddOnsModel;

class AddOnsService extends BaseModuleService
{
    private AddOnsModel $model;

    public function __construct()
    {
        parent::__construct('restaurant_hotels', 'add_ons');
