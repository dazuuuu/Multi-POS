...
use App\Backend\Modules\Industry\RestaurantHotels\Restaurant\Models\TablesModel;

class TablesService extends BaseModuleService
{
    private TablesModel $model;

    public function __construct()
    {
        parent::__construct('restaurant_hotels', 'tables');
