...
use App\Backend\Modules\Industry\BeautySpa\Appointments\Models\CalendarModel;

class CalendarService extends BaseModuleService
{
    private CalendarModel $model;

    public function __construct()
    {
        parent::__construct('beauty_spa', 'calendar');
