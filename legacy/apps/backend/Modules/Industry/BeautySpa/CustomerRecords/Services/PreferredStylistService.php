...
use App\Backend\Modules\Industry\BeautySpa\CustomerRecords\Models\PreferredStylistModel;

class PreferredStylistService extends BaseModuleService
{
    private PreferredStylistModel $model;

    public function __construct()
    {
        parent::__construct('beauty_spa', 'preferred_stylist');
        $this->model = new PreferredStylistModel();
    }
