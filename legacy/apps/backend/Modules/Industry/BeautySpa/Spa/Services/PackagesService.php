...
use App\Backend\Modules\Industry\BeautySpa\Spa\Models\PackagesModel;

class PackagesService extends BaseModuleService
{
    private PackagesModel $model;

    public function __construct()
    {
        parent::__construct('beauty_spa', 'packages');
