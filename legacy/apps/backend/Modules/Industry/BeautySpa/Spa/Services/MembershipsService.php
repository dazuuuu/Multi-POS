...
use App\Backend\Modules\Industry\BeautySpa\Spa\Models\MembershipsModel;

class MembershipsService extends BaseModuleService
{
    private MembershipsModel $model;

    public function __construct()
    {
        parent::__construct('beauty_spa', 'memberships');
