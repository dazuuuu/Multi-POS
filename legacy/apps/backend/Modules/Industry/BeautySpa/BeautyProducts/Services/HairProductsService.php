...
use App\Backend\Modules\Industry\BeautySpa\BeautyProducts\Models\HairProductsModel;

class HairProductsService extends BaseModuleService
{
    private HairProductsModel $model;

    public function __construct()
    {
        parent::__construct('beauty_spa', 'hair_products');
        $this->model = new HairProductsModel();
    }
