...
use App\Backend\Modules\Industry\BeautySpa\BeautyProducts\Models\RetailCosmeticsModel;

class RetailCosmeticsService extends BaseModuleService
{
    private RetailCosmeticsModel $model;

    public function __construct()
    {
        parent::__construct('beauty_spa', 'retail_cosmetics');
        $this->model = new RetailCosmeticsModel();
    }
