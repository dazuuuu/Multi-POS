...
use App\Backend\Modules\Core\SalesPos\Models\ProductSearchModel;

class ProductSearchService extends BaseModuleService
{
    private ProductSearchModel $model;

    public function __construct()
    {
        parent::__construct('sales_pos', 'product_search');
