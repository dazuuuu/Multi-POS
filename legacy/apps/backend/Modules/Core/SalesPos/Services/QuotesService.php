...
use App\Backend\Modules\Core\SalesPos\Models\QuotesModel;

class QuotesService extends BaseModuleService
{
    private QuotesModel $model;

    public function __construct()
    {
        parent::__construct('sales_pos', 'quotes');
