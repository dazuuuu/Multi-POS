...
use App\Backend\Modules\Core\Reports\Models\SalesReportsModel;

class SalesReportsService extends BaseModuleService
{
    private SalesReportsModel $model;

    public function __construct()
    {
        parent::__construct('reports', 'sales_reports');
        $this->model = new SalesReportsModel();
    }
