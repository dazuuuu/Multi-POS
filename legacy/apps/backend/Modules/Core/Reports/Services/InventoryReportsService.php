...
use App\Backend\Modules\Core\Reports\Models\InventoryReportsModel;

class InventoryReportsService extends BaseModuleService
{
    private InventoryReportsModel $model;

    public function __construct()
    {
        parent::__construct('reports', 'inventory_reports');
        $this->model = new InventoryReportsModel();
    }
