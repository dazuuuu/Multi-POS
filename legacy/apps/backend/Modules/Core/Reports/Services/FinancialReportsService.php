...
use App\Backend\Modules\Core\Reports\Models\FinancialReportsModel;

class FinancialReportsService extends BaseModuleService
{
    private FinancialReportsModel $model;

    public function __construct()
    {
        parent::__construct('reports', 'financial_reports');
