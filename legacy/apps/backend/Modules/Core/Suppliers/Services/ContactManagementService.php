...
use App\Backend\Modules\Core\Suppliers\Models\ContactManagementModel;

class ContactManagementService extends BaseModuleService
{
    private ContactManagementModel $model;

    public function __construct()
    {
        parent::__construct('suppliers', 'contact_management');
        $this->model = new ContactManagementModel();
    }
