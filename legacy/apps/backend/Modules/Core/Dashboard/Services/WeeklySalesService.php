...
use App\Backend\Modules\Core\Dashboard\Models\WeeklySalesModel;

class WeeklySalesService extends BaseModuleService
{
    private WeeklySalesModel $model;

    public function __construct()
    {
        parent::__construct('dashboard', 'weekly_sales');
        $this->model = new WeeklySalesModel();
    }
