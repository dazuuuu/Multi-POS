...
use App\Backend\Modules\Core\Dashboard\Models\BestCustomersModel;

class BestCustomersService extends BaseModuleService
{
    private BestCustomersModel $model;

    public function __construct()
    {
        parent::__construct('dashboard', 'best_customers');
        $this->model = new BestCustomersModel();
    }
