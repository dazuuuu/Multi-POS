...
use App\Backend\Modules\Core\Dashboard\Models\EmployeePerformanceModel;

class EmployeePerformanceService extends BaseModuleService
{
    private EmployeePerformanceModel $model;

    public function __construct()
    {
        parent::__construct('dashboard', 'employee_performance');
        $this->model = new EmployeePerformanceModel();
    }
