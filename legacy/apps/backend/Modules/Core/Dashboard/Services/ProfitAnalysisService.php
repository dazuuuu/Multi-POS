...
use App\Backend\Modules\Core\Dashboard\Models\ProfitAnalysisModel;

class ProfitAnalysisService extends BaseModuleService
{
    private ProfitAnalysisModel $model;

    public function __construct()
    {
        parent::__construct('dashboard', 'profit_analysis');
        $this->model = new ProfitAnalysisModel();
    }
