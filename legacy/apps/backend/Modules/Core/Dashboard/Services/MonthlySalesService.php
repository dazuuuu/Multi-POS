...
use App\Backend\Modules\Core\Dashboard\Models\MonthlySalesModel;

class MonthlySalesService extends BaseModuleService
{
    private MonthlySalesModel $model;

    public function __construct()
    {
        parent::__construct('dashboard', 'monthly_sales');
        $this->model = new MonthlySalesModel();
    }
