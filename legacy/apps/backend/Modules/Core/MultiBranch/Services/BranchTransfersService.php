...
use App\Backend\Modules\Core\MultiBranch\Models\BranchTransfersModel;

class BranchTransfersService extends BaseModuleService
{
    private BranchTransfersModel $model;

    public function __construct()
    {
        parent::__construct('multi_branch', 'branch_transfers');
        $this->model = new BranchTransfersModel();
    }
