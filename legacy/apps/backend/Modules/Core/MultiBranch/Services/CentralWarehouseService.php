...
use App\Backend\Modules\Core\MultiBranch\Models\CentralWarehouseModel;

class CentralWarehouseService extends BaseModuleService
{
    private CentralWarehouseModel $model;

    public function __construct()
    {
        parent::__construct('multi_branch', 'central_warehouse');
        $this->model = new CentralWarehouseModel();
    }
