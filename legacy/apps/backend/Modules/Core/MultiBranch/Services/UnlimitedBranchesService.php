...
use App\Backend\Modules\Core\MultiBranch\Models\UnlimitedBranchesModel;

class UnlimitedBranchesService extends BaseModuleService
{
    private UnlimitedBranchesModel $model;

    public function __construct()
    {
        parent::__construct('multi_branch', 'unlimited_branches');
        $this->model = new UnlimitedBranchesModel();
    }
