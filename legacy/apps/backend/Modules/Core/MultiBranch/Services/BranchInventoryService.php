...
use App\Backend\Modules\Core\MultiBranch\Models\BranchInventoryModel;

class BranchInventoryService extends BaseModuleService
{
    private BranchInventoryModel $model;

    public function __construct()
    {
        parent::__construct('multi_branch', 'branch_inventory');
        $this->model = new BranchInventoryModel();
    }
