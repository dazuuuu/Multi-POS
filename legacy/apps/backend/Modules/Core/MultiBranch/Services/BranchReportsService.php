...
use App\Backend\Modules\Core\MultiBranch\Models\BranchReportsModel;

class BranchReportsService extends BaseModuleService
{
    private BranchReportsModel $model;

    public function __construct()
    {
        parent::__construct('multi_branch', 'branch_reports');
        $this->model = new BranchReportsModel();
    }
