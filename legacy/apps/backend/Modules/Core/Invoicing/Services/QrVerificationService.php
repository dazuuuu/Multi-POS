...
use App\Backend\Modules\Core\Invoicing\Models\QrVerificationModel;

class QrVerificationService extends BaseModuleService
{
    private QrVerificationModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'qr_verification');
        $this->model = new QrVerificationModel();
    }
