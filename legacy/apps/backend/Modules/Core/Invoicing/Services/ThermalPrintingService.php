...
use App\Backend\Modules\Core\Invoicing\Models\ThermalPrintingModel;

class ThermalPrintingService extends BaseModuleService
{
    private ThermalPrintingModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'thermal_printing');
        $this->model = new ThermalPrintingModel();
    }
