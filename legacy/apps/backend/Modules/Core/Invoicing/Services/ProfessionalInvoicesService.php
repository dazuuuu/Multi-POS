...
use App\Backend\Modules\Core\Invoicing\Models\ProfessionalInvoicesModel;

class ProfessionalInvoicesService extends BaseModuleService
{
    private ProfessionalInvoicesModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'professional_invoices');
        $this->model = new ProfessionalInvoicesModel();
    }
