...
use App\Backend\Modules\Core\Invoicing\Models\TaxInvoicesModel;

class TaxInvoicesService extends BaseModuleService
{
    private TaxInvoicesModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'tax_invoices');
        $this->model = new TaxInvoicesModel();
    }
