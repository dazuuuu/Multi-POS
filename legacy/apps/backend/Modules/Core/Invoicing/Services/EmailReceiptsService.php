...
use App\Backend\Modules\Core\Invoicing\Models\EmailReceiptsModel;

class EmailReceiptsService extends BaseModuleService
{
    private EmailReceiptsModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'email_receipts');
        $this->model = new EmailReceiptsModel();
    }
