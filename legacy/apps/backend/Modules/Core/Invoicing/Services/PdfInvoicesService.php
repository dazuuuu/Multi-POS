...
use App\Backend\Modules\Core\Invoicing\Models\PdfInvoicesModel;

class PdfInvoicesService extends BaseModuleService
{
    private PdfInvoicesModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'pdf_invoices');
        $this->model = new PdfInvoicesModel();
    }
