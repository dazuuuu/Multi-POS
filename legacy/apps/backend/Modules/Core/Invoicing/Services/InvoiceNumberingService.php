...
use App\Backend\Modules\Core\Invoicing\Models\InvoiceNumberingModel;

class InvoiceNumberingService extends BaseModuleService
{
    private InvoiceNumberingModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'invoice_numbering');
        $this->model = new InvoiceNumberingModel();
    }
