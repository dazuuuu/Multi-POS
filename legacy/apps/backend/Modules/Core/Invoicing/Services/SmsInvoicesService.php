...
use App\Backend\Modules\Core\Invoicing\Models\SmsInvoicesModel;

class SmsInvoicesService extends BaseModuleService
{
    private SmsInvoicesModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'sms_invoices');
        $this->model = new SmsInvoicesModel();
    }
