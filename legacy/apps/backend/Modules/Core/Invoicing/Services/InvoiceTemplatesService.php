...
use App\Backend\Modules\Core\Invoicing\Models\InvoiceTemplatesModel;

class InvoiceTemplatesService extends BaseModuleService
{
    private InvoiceTemplatesModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'invoice_templates');
        $this->model = new InvoiceTemplatesModel();
    }
