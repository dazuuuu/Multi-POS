...
use App\Backend\Modules\Core\Invoicing\Models\EmailInvoicesModel;

class EmailInvoicesService extends BaseModuleService
{
    private EmailInvoicesModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'email_invoices');
        $this->model = new EmailInvoicesModel();
    }
