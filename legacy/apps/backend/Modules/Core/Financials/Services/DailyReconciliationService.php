...
use App\Backend\Modules\Core\Financials\Models\DailyReconciliationModel;

class DailyReconciliationService extends BaseModuleService
{
    private DailyReconciliationModel $model;

    public function __construct()
    {
        parent::__construct('financials', 'daily_reconciliation');
        $this->model = new DailyReconciliationModel();
    }
