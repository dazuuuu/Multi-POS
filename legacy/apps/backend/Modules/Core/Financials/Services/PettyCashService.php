...
use App\Backend\Modules\Core\Financials\Models\PettyCashModel;

class PettyCashService extends BaseModuleService
{
    private PettyCashModel $model;

    public function __construct()
    {
        parent::__construct('financials', 'petty_cash');
        $this->model = new PettyCashModel();
    }
