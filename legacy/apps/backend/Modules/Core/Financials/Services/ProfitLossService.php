...
use App\Backend\Modules\Core\Financials\Models\ProfitLossModel;

class ProfitLossService extends BaseModuleService
{
    private ProfitLossModel $model;

    public function __construct()
    {
        parent::__construct('financials', 'profit_loss');
