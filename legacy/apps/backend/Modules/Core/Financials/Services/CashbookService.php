...
use App\Backend\Modules\Core\Financials\Models\CashbookModel;

class CashbookService extends BaseModuleService
{
    private CashbookModel $model;

    public function __construct()
    {
        parent::__construct('financials', 'cashbook');
        $this->model = new CashbookModel();
    }
