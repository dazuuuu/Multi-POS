...
use App\Backend\Modules\Core\UserRoles\Models\StylistModel;

class StylistService extends BaseModuleService
{
    private StylistModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'stylist');
