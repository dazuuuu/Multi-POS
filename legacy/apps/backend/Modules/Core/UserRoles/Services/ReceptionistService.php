...
use App\Backend\Modules\Core\UserRoles\Models\ReceptionistModel;

class ReceptionistService extends BaseModuleService
{
    private ReceptionistModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'receptionist');
        $this->model = new ReceptionistModel();
    }
