...
use App\Backend\Modules\Core\UserRoles\Models\LaboratoryTechnicianModel;

class LaboratoryTechnicianService extends BaseModuleService
{
    private LaboratoryTechnicianModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'laboratory_technician');
        $this->model = new LaboratoryTechnicianModel();
    }
