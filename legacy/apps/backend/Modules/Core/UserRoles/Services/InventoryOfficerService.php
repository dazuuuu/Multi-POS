...
use App\Backend\Modules\Core\UserRoles\Models\InventoryOfficerModel;

class InventoryOfficerService extends BaseModuleService
{
    private InventoryOfficerModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'inventory_officer');
        $this->model = new InventoryOfficerModel();
    }
