...
use App\Backend\Modules\Core\UserRoles\Models\ActivityLogsModel;

class ActivityLogsService extends BaseModuleService
{
    private ActivityLogsModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'activity_logs');
