...
use App\Backend\Modules\Core\UserRoles\Models\BranchManagerModel;

class BranchManagerService extends BaseModuleService
{
    private BranchManagerModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'branch_manager');
