...
use App\Backend\Modules\Core\UserRoles\Models\PinLoginModel;

class PinLoginService extends BaseModuleService
{
    private PinLoginModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'pin_login');
        $this->model = new PinLoginModel();
    }
