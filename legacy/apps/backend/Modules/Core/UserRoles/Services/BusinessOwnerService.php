...
use App\Backend\Modules\Core\UserRoles\Models\BusinessOwnerModel;

class BusinessOwnerService extends BaseModuleService
{
    private BusinessOwnerModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'business_owner');
        $this->model = new BusinessOwnerModel();
    }
