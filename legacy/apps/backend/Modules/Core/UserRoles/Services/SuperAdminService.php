...
use App\Backend\Modules\Core\UserRoles\Models\SuperAdminModel;

class SuperAdminService extends BaseModuleService
{
    private SuperAdminModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'super_admin');
