...
use App\Backend\Modules\Core\UserRoles\Models\PharmacistModel;

class PharmacistService extends BaseModuleService
{
    private PharmacistModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'pharmacist');
        $this->model = new PharmacistModel();
    }
