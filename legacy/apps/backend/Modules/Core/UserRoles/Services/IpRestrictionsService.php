...
use App\Backend\Modules\Core\UserRoles\Models\IpRestrictionsModel;

class IpRestrictionsService extends BaseModuleService
{
    private IpRestrictionsModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'ip_restrictions');
        $this->model = new IpRestrictionsModel();
    }
