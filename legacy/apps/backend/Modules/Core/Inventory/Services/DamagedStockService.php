...
use App\Backend\Modules\Core\Inventory\Models\DamagedStockModel;

class DamagedStockService extends BaseModuleService
{
    private DamagedStockModel $model;

    public function __construct()
    {
        parent::__construct('inventory', 'damaged_stock');
        $this->model = new DamagedStockModel();
    }
