...
use App\Backend\Modules\Core\Inventory\Models\InventoryHistoryModel;

class InventoryHistoryService extends BaseModuleService
{
    private InventoryHistoryModel $model;

    public function __construct()
    {
        parent::__construct('inventory', 'inventory_history');
