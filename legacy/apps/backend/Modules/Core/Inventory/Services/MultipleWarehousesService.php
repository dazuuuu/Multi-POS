...
use App\Backend\Modules\Core\Inventory\Models\MultipleWarehousesModel;

class MultipleWarehousesService extends BaseModuleService
{
    private MultipleWarehousesModel $model;

    public function __construct()
    {
        parent::__construct('inventory', 'multiple_warehouses');
        $this->model = new MultipleWarehousesModel();
    }
