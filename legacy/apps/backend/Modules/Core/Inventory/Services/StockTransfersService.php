...
use App\Backend\Modules\Core\Inventory\Models\StockTransfersModel;

class StockTransfersService extends BaseModuleService
{
    private StockTransfersModel $model;

    public function __construct()
    {
        parent::__construct('inventory', 'stock_transfers');
        $this->model = new StockTransfersModel();
    }
