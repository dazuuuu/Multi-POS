...
use App\Backend\Modules\Core\Inventory\Models\BarcodeGenerationModel;

class BarcodeGenerationService extends BaseModuleService
{
    private BarcodeGenerationModel $model;

    public function __construct()
    {
        parent::__construct('inventory', 'barcode_generation');
        $this->model = new BarcodeGenerationModel();
    }
