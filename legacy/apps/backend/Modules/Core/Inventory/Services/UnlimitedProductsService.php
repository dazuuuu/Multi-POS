...
use App\Backend\Modules\Core\Inventory\Models\UnlimitedProductsModel;

class UnlimitedProductsService extends BaseModuleService
{
    private UnlimitedProductsModel $model;

    public function __construct()
    {
        parent::__construct('inventory', 'unlimited_products');
        $this->model = new UnlimitedProductsModel();
    }
