...
use App\Backend\Modules\Core\Inventory\Models\SupplierOrdersModel;

class SupplierOrdersService extends BaseModuleService
{
    private SupplierOrdersModel $model;

    public function __construct()
    {
        parent::__construct('inventory', 'supplier_orders');
        $this->model = new SupplierOrdersModel();
    }
