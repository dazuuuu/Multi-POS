...
use App\Backend\Modules\Core\Inventory\Models\InventoryValuationModel;

class InventoryValuationService extends BaseModuleService
{
    private InventoryValuationModel $model;

    public function __construct()
    {
        parent::__construct('inventory', 'inventory_valuation');
        $this->model = new InventoryValuationModel();
    }
