...
use App\Backend\Modules\Core\Inventory\Models\ReorderLevelsModel;

class ReorderLevelsService extends BaseModuleService
{
    private ReorderLevelsModel $model;

    public function __construct()
    {
        parent::__construct('inventory', 'reorder_levels');
        $this->model = new ReorderLevelsModel();
    }
