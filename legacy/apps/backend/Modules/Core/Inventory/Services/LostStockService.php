...
use App\Backend\Modules\Core\Inventory\Models\LostStockModel;

class LostStockService extends BaseModuleService
{
    private LostStockModel $model;

    public function __construct()
    {
        parent::__construct('inventory', 'lost_stock');
        $this->model = new LostStockModel();
    }
