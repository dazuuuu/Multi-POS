...
use App\Backend\Modules\Core\Inventory\Models\ProductImagesModel;

class ProductImagesService extends BaseModuleService
{
    private ProductImagesModel $model;

    public function __construct()
    {
        parent::__construct('inventory', 'product_images');
