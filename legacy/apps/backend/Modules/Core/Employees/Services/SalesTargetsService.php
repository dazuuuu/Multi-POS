...
use App\Backend\Modules\Core\Employees\Models\SalesTargetsModel;

class SalesTargetsService extends BaseModuleService
{
    private SalesTargetsModel $model;

    public function __construct()
    {
        parent::__construct('employees', 'sales_targets');
        $this->model = new SalesTargetsModel();
    }
