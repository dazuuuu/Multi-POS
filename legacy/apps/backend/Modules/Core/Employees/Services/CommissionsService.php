...
use App\Backend\Modules\Core\Employees\Models\CommissionsModel;

class CommissionsService extends BaseModuleService
{
    private CommissionsModel $model;

    public function __construct()
    {
        parent::__construct('employees', 'commissions');
        $this->model = new CommissionsModel();
    }
