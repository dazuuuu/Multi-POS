...
use App\Backend\Modules\Core\Employees\Models\ShiftManagementModel;

class ShiftManagementService extends BaseModuleService
{
    private ShiftManagementModel $model;

    public function __construct()
    {
        parent::__construct('employees', 'shift_management');
        $this->model = new ShiftManagementModel();
    }
