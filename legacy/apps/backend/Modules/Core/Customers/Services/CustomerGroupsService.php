...
use App\Backend\Modules\Core\Customers\Models\CustomerGroupsModel;

class CustomerGroupsService extends BaseModuleService
{
    private CustomerGroupsModel $model;

    public function __construct()
    {
        parent::__construct('customers', 'customer_groups');
        $this->model = new CustomerGroupsModel();
    }
