...
use App\Backend\Modules\Core\Customers\Models\CreditLimitsModel;

class CreditLimitsService extends BaseModuleService
{
    private CreditLimitsModel $model;

    public function __construct()
    {
        parent::__construct('customers', 'credit_limits');
        $this->model = new CreditLimitsModel();
    }
