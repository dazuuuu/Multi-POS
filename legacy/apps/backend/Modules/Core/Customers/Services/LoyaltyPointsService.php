...
use App\Backend\Modules\Core\Customers\Models\LoyaltyPointsModel;

class LoyaltyPointsService extends BaseModuleService
{
    private LoyaltyPointsModel $model;

    public function __construct()
    {
        parent::__construct('customers', 'loyalty_points');
        $this->model = new LoyaltyPointsModel();
    }
