...
use App\Backend\Modules\Core\BusinessManagement\Models\OperatingHoursModel;

class OperatingHoursService extends BaseModuleService
{
    private OperatingHoursModel $model;

    public function __construct()
    {
        parent::__construct('business_management', 'operating_hours');
        $this->model = new OperatingHoursModel();
    }
