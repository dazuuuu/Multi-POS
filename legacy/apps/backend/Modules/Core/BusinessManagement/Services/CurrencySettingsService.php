...
use App\Backend\Modules\Core\BusinessManagement\Models\CurrencySettingsModel;

class CurrencySettingsService extends BaseModuleService
{
    private CurrencySettingsModel $model;

    public function __construct()
    {
        parent::__construct('business_management', 'currency_settings');
        $this->model = new CurrencySettingsModel();
    }
