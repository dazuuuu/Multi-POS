...
use App\Backend\Modules\Core\BusinessManagement\Models\MultipleBusinessesModel;

class MultipleBusinessesService extends BaseModuleService
{
    private MultipleBusinessesModel $model;

    public function __construct()
    {
        parent::__construct('business_management', 'multiple_businesses');
        $this->model = new MultipleBusinessesModel();
    }
