...
use App\Services\Industry\Healthcare\PrescriptionsService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

class PrescriptionsController extends ApiController
{
    public function __construct(private readonly PrescriptionsService $service) {}
