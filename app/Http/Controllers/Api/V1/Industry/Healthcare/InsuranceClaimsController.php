...
use App\Services\Industry\Healthcare\InsuranceClaimsService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

class InsuranceClaimsController extends ApiController
{
    public function __construct(private readonly InsuranceClaimsService $service) {}
