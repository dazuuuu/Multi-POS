...
use App\Backend\Modules\Industry\AgrovetsHardware\Agrovet\Models\AnimalMedicinesModel;

class AnimalMedicinesService extends BaseModuleService
{
    private AnimalMedicinesModel $model;

    public function __construct()
    {
        parent::__construct('agrovets_hardware', 'animal_medicines');
        $this->model = new AnimalMedicinesModel();
    }
