...
use App\Backend\Modules\Industry\AgrovetsHardware\Agrovet\Models\FeedsModel;

class FeedsService extends BaseModuleService
{
    private FeedsModel $model;

    public function __construct()
    {
        parent::__construct('agrovets_hardware', 'feeds');
