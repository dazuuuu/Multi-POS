...
use App\Backend\Modules\Industry\AgrovetsHardware\Farming\Models\ChemicalsModel;

class ChemicalsService extends BaseModuleService
{
    private ChemicalsModel $model;

    public function __construct()
    {
        parent::__construct('agrovets_hardware', 'chemicals');
        $this->model = new ChemicalsModel();
    }
