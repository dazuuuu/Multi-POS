...
use App\Backend\Modules\Industry\AgrovetsHardware\Farming\Models\IrrigationProductsModel;

class IrrigationProductsService extends BaseModuleService
{
    private IrrigationProductsModel $model;

    public function __construct()
    {
        parent::__construct('agrovets_hardware', 'irrigation_products');
        $this->model = new IrrigationProductsModel();
    }
