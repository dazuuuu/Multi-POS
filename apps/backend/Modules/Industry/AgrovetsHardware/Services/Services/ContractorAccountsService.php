...
use App\Backend\Modules\Industry\AgrovetsHardware\Services\Models\ContractorAccountsModel;

class ContractorAccountsService extends BaseModuleService
{
    private ContractorAccountsModel $model;

    public function __construct()
    {
        parent::__construct('agrovets_hardware', 'contractor_accounts');
        $this->model = new ContractorAccountsModel();
    }
