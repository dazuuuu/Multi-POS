...
use App\Backend\Modules\Industry\AgrovetsHardware\Services\Models\PaintMixingModel;

class PaintMixingService extends BaseModuleService
{
    private PaintMixingModel $model;

    public function __construct()
    {
        parent::__construct('agrovets_hardware', 'paint_mixing');
        $this->model = new PaintMixingModel();
    }
