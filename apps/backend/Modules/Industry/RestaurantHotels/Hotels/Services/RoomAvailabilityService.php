...
use App\Backend\Modules\Industry\RestaurantHotels\Hotels\Models\RoomAvailabilityModel;

class RoomAvailabilityService extends BaseModuleService
{
    private RoomAvailabilityModel $model;

    public function __construct()
    {
        parent::__construct('restaurant_hotels', 'room_availability');
