...
use App\Backend\Modules\Industry\RestaurantHotels\Hotels\Models\ReservationsModel;

class ReservationsService extends BaseModuleService
{
    private ReservationsModel $model;

    public function __construct()
    {
        parent::__construct('restaurant_hotels', 'reservations');
