...
use App\Backend\Modules\Industry\RestaurantHotels\Hotels\Models\HousekeepingModel;

class HousekeepingService extends BaseModuleService
{
    private HousekeepingModel $model;

    public function __construct()
    {
        parent::__construct('restaurant_hotels', 'housekeeping');
        $this->model = new HousekeepingModel();
    }
