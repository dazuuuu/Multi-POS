...
use App\Backend\Modules\Industry\RestaurantHotels\Hotels\Models\RoomServiceModel;

class RoomServiceService extends BaseModuleService
{
    private RoomServiceModel $model;

    public function __construct()
    {
        parent::__construct('restaurant_hotels', 'room_service');
        $this->model = new RoomServiceModel();
    }
