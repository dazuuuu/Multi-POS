...
use App\Backend\Modules\Industry\Healthcare\Wards\Models\DischargesModel;

class DischargesService extends BaseModuleService
{
    private DischargesModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'discharges');
        $this->model = new DischargesModel();
    }
