...
use App\Backend\Modules\Industry\Healthcare\Wards\Models\NursingAssignmentsModel;

class NursingAssignmentsService extends BaseModuleService
{
    private NursingAssignmentsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'nursing_assignments');
        $this->model = new NursingAssignmentsModel();
    }
