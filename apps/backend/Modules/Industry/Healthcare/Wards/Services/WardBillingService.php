...
use App\Backend\Modules\Industry\Healthcare\Wards\Models\WardBillingModel;

class WardBillingService extends BaseModuleService
{
    private WardBillingModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'ward_billing');
        $this->model = new WardBillingModel();
    }
