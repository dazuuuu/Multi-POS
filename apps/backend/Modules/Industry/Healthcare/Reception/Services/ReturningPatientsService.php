...
use App\Backend\Modules\Industry\Healthcare\Reception\Models\ReturningPatientsModel;

class ReturningPatientsService extends BaseModuleService
{
    private ReturningPatientsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'returning_patients');
        $this->model = new ReturningPatientsModel();
    }
