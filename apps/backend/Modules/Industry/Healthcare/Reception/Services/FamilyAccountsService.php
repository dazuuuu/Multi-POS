...
use App\Backend\Modules\Industry\Healthcare\Reception\Models\FamilyAccountsModel;

class FamilyAccountsService extends BaseModuleService
{
    private FamilyAccountsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'family_accounts');
        $this->model = new FamilyAccountsModel();
    }
