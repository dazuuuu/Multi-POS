...
use App\Backend\Modules\Industry\Healthcare\Theatre\Models\OperationBillingModel;

class OperationBillingService extends BaseModuleService
{
    private OperationBillingModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'operation_billing');
        $this->model = new OperationBillingModel();
    }
