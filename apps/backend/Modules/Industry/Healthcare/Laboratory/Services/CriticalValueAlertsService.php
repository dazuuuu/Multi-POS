...
use App\Backend\Modules\Industry\Healthcare\Laboratory\Models\CriticalValueAlertsModel;

class CriticalValueAlertsService extends BaseModuleService
{
    private CriticalValueAlertsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'critical_value_alerts');
        $this->model = new CriticalValueAlertsModel();
    }
