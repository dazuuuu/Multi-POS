...
use App\Backend\Modules\Industry\Healthcare\Laboratory\Models\ReferenceRangesModel;

class ReferenceRangesService extends BaseModuleService
{
    private ReferenceRangesModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'reference_ranges');
        $this->model = new ReferenceRangesModel();
    }
