...
use App\Backend\Modules\Industry\Healthcare\Laboratory\Models\BarcodeLabelsModel;

class BarcodeLabelsService extends BaseModuleService
{
    private BarcodeLabelsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'barcode_labels');
        $this->model = new BarcodeLabelsModel();
    }
