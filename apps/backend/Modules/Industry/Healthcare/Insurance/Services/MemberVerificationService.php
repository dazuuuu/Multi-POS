...
use App\Backend\Modules\Industry\Healthcare\Insurance\Models\MemberVerificationModel;

class MemberVerificationService extends BaseModuleService
{
    private MemberVerificationModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'member_verification');
        $this->model = new MemberVerificationModel();
    }
