...
use App\Backend\Modules\Industry\Healthcare\Emr\Models\ImmunizationRecordsModel;

class ImmunizationRecordsService extends BaseModuleService
{
    private ImmunizationRecordsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'immunization_records');
        $this->model = new ImmunizationRecordsModel();
    }
