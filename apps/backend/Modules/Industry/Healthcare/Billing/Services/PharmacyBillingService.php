...
use App\Backend\Modules\Industry\Healthcare\Billing\Models\PharmacyBillingModel;

class PharmacyBillingService extends BaseModuleService
{
    private PharmacyBillingModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'pharmacy_billing');
        $this->model = new PharmacyBillingModel();
    }
