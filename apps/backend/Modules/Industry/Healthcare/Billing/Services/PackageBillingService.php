...
use App\Backend\Modules\Industry\Healthcare\Billing\Models\PackageBillingModel;

class PackageBillingService extends BaseModuleService
{
    private PackageBillingModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'package_billing');
        $this->model = new PackageBillingModel();
    }
