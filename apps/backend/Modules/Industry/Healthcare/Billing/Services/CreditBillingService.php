...
use App\Backend\Modules\Industry\Healthcare\Billing\Models\CreditBillingModel;

class CreditBillingService extends BaseModuleService
{
    private CreditBillingModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'credit_billing');
        $this->model = new CreditBillingModel();
    }
