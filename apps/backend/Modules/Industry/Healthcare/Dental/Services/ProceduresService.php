...
use App\Backend\Modules\Industry\Healthcare\Dental\Models\ProceduresModel;

class ProceduresService extends BaseModuleService
{
    private ProceduresModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'procedures');
