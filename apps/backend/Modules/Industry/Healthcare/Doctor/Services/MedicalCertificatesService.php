...
use App\Backend\Modules\Industry\Healthcare\Doctor\Models\MedicalCertificatesModel;

class MedicalCertificatesService extends BaseModuleService
{
    private MedicalCertificatesModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'medical_certificates');
        $this->model = new MedicalCertificatesModel();
    }
