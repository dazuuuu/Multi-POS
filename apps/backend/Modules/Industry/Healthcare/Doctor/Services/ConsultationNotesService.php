...
use App\Backend\Modules\Industry\Healthcare\Doctor\Models\ConsultationNotesModel;

class ConsultationNotesService extends BaseModuleService
{
    private ConsultationNotesModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'consultation_notes');
        $this->model = new ConsultationNotesModel();
    }
