...
use App\Backend\Modules\Industry\Healthcare\Doctor\Models\PrescriptionsModel;

class PrescriptionsService extends BaseModuleService
{
    private PrescriptionsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'prescriptions');
        $this->model = new PrescriptionsModel();
    }
