...
use App\Backend\Modules\Industry\Healthcare\Administration\Models\DrugUtilizationReportsModel;

class DrugUtilizationReportsService extends BaseModuleService
{
    private DrugUtilizationReportsModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'drug_utilization_reports');
        $this->model = new DrugUtilizationReportsModel();
    }
