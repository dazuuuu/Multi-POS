...
use App\Backend\Modules\Industry\Healthcare\Physiotherapy\Models\ExercisePlansModel;

class ExercisePlansService extends BaseModuleService
{
    private ExercisePlansModel $model;

    public function __construct()
    {
        parent::__construct('healthcare', 'exercise_plans');
        $this->model = new ExercisePlansModel();
    }
