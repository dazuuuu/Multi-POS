...
use App\Backend\Modules\Industry\BarLiquor\NightReports\Models\ShiftClosingModel;

class ShiftClosingService extends BaseModuleService
{
    private ShiftClosingModel $model;

    public function __construct()
    {
        parent::__construct('bar_liquor', 'shift_closing');
        $this->model = new ShiftClosingModel();
    }
