...
use App\Backend\Modules\Industry\BarLiquor\BarOperations\Models\PegMeasurementsModel;

class PegMeasurementsService extends BaseModuleService
{
    private PegMeasurementsModel $model;

    public function __construct()
    {
        parent::__construct('bar_liquor', 'peg_measurements');
        $this->model = new PegMeasurementsModel();
    }
