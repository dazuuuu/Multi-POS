...
use App\Backend\Modules\Industry\BeautySpa\Services\Models\MassageModel;

class MassageService extends BaseModuleService
{
    private MassageModel $model;

    public function __construct()
    {
        parent::__construct('beauty_spa', 'massage');
