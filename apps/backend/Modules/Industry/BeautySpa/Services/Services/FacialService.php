...
use App\Backend\Modules\Industry\BeautySpa\Services\Models\FacialModel;

class FacialService extends BaseModuleService
{
    private FacialModel $model;

    public function __construct()
    {
        parent::__construct('beauty_spa', 'facial');
        $this->model = new FacialModel();
    }
