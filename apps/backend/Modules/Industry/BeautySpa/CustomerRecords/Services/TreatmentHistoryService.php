...
use App\Backend\Modules\Industry\BeautySpa\CustomerRecords\Models\TreatmentHistoryModel;

class TreatmentHistoryService extends BaseModuleService
{
    private TreatmentHistoryModel $model;

    public function __construct()
    {
        parent::__construct('beauty_spa', 'treatment_history');
        $this->model = new TreatmentHistoryModel();
    }
