...
use App\Backend\Modules\Industry\BeautySpa\CustomerRecords\Models\VisitHistoryModel;

class VisitHistoryService extends BaseModuleService
{
    private VisitHistoryModel $model;

    public function __construct()
    {
        parent::__construct('beauty_spa', 'visit_history');
        $this->model = new VisitHistoryModel();
    }
