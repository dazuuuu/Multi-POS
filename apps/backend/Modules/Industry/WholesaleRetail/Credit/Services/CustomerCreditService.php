...
use App\Backend\Modules\Industry\WholesaleRetail\Credit\Models\CustomerCreditModel;

class CustomerCreditService extends BaseModuleService
{
    private CustomerCreditModel $model;

    public function __construct()
    {
        parent::__construct('wholesale_retail', 'customer_credit');
        $this->model = new CustomerCreditModel();
    }
