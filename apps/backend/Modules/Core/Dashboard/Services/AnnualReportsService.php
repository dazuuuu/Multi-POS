...
use App\Backend\Modules\Core\Dashboard\Models\AnnualReportsModel;

class AnnualReportsService extends BaseModuleService
{
    private AnnualReportsModel $model;

    public function __construct()
    {
        parent::__construct('dashboard', 'annual_reports');
        $this->model = new AnnualReportsModel();
    }
