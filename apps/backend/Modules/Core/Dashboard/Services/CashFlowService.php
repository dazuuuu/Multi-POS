...
use App\Backend\Modules\Core\Dashboard\Models\CashFlowModel;

class CashFlowService extends BaseModuleService
{
    private CashFlowModel $model;

    public function __construct()
    {
        parent::__construct('dashboard', 'cash_flow');
