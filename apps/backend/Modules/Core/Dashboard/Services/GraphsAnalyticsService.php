...
use App\Backend\Modules\Core\Dashboard\Models\GraphsAnalyticsModel;

class GraphsAnalyticsService extends BaseModuleService
{
    private GraphsAnalyticsModel $model;

    public function __construct()
    {
        parent::__construct('dashboard', 'graphs_analytics');
        $this->model = new GraphsAnalyticsModel();
    }
