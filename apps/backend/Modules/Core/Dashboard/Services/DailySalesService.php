...
use App\Backend\Modules\Core\Dashboard\Models\DailySalesModel;

class DailySalesService extends BaseModuleService
{
    private DailySalesModel $model;

    public function __construct()
    {
        parent::__construct('dashboard', 'daily_sales');
        $this->model = new DailySalesModel();
    }
