...
use App\Backend\Modules\Core\Invoicing\Models\RecurringInvoicesModel;

class RecurringInvoicesService extends BaseModuleService
{
    private RecurringInvoicesModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'recurring_invoices');
        $this->model = new RecurringInvoicesModel();
    }
