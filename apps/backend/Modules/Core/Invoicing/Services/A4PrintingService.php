...
use App\Backend\Modules\Core\Invoicing\Models\A4PrintingModel;

class A4PrintingService extends BaseModuleService
{
    private A4PrintingModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'a4_printing');
        $this->model = new A4PrintingModel();
    }
