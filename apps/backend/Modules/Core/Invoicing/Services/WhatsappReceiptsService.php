...
use App\Backend\Modules\Core\Invoicing\Models\WhatsappReceiptsModel;

class WhatsappReceiptsService extends BaseModuleService
{
    private WhatsappReceiptsModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'whatsapp_receipts');
        $this->model = new WhatsappReceiptsModel();
    }
