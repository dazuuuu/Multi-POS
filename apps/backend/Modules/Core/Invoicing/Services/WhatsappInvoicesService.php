...
use App\Backend\Modules\Core\Invoicing\Models\WhatsappInvoicesModel;

class WhatsappInvoicesService extends BaseModuleService
{
    private WhatsappInvoicesModel $model;

    public function __construct()
    {
        parent::__construct('invoicing', 'whatsapp_invoices');
        $this->model = new WhatsappInvoicesModel();
    }
