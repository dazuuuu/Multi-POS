...
use App\Backend\Modules\Core\Reports\Models\SupplierReportsModel;

class SupplierReportsService extends BaseModuleService
{
    private SupplierReportsModel $model;

    public function __construct()
    {
        parent::__construct('reports', 'supplier_reports');
        $this->model = new SupplierReportsModel();
    }
