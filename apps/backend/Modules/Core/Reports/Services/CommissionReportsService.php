...
use App\Backend\Modules\Core\Reports\Models\CommissionReportsModel;

class CommissionReportsService extends BaseModuleService
{
    private CommissionReportsModel $model;

    public function __construct()
    {
        parent::__construct('reports', 'commission_reports');
        $this->model = new CommissionReportsModel();
    }
