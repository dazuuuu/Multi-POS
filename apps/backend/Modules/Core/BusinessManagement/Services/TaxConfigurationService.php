...
use App\Backend\Modules\Core\BusinessManagement\Models\TaxConfigurationModel;

class TaxConfigurationService extends BaseModuleService
{
    private TaxConfigurationModel $model;

    public function __construct()
    {
        parent::__construct('business_management', 'tax_configuration');
