...
use App\Backend\Modules\Core\BusinessManagement\Models\TimezoneSettingsModel;

class TimezoneSettingsService extends BaseModuleService
{
    private TimezoneSettingsModel $model;

    public function __construct()
    {
        parent::__construct('business_management', 'timezone_settings');
        $this->model = new TimezoneSettingsModel();
    }
