...
use App\Backend\Modules\Core\BusinessManagement\Models\BusinessLogoBrandingModel;

class BusinessLogoBrandingService extends BaseModuleService
{
    private BusinessLogoBrandingModel $model;

    public function __construct()
    {
        parent::__construct('business_management', 'business_logo_branding');
        $this->model = new BusinessLogoBrandingModel();
    }
