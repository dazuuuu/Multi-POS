...
use App\Backend\Modules\Core\Customers\Models\BirthdayRemindersModel;

class BirthdayRemindersService extends BaseModuleService
{
    private BirthdayRemindersModel $model;

    public function __construct()
    {
        parent::__construct('customers', 'birthday_reminders');
        $this->model = new BirthdayRemindersModel();
    }
