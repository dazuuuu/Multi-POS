...
use App\Backend\Modules\Core\SalesPos\Models\PromotionsModel;

class PromotionsService extends BaseModuleService
{
    private PromotionsModel $model;

    public function __construct()
    {
        parent::__construct('sales_pos', 'promotions');
        $this->model = new PromotionsModel();
    }
