...
use App\Backend\Modules\Core\MultiBranch\Models\BranchExpensesModel;

class BranchExpensesService extends BaseModuleService
{
    private BranchExpensesModel $model;

    public function __construct()
    {
        parent::__construct('multi_branch', 'branch_expenses');
        $this->model = new BranchExpensesModel();
    }
