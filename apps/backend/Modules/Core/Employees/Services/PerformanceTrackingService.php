...
use App\Backend\Modules\Core\Employees\Models\PerformanceTrackingModel;

class PerformanceTrackingService extends BaseModuleService
{
    private PerformanceTrackingModel $model;

    public function __construct()
    {
        parent::__construct('employees', 'performance_tracking');
        $this->model = new PerformanceTrackingModel();
    }
