...
use App\Backend\Modules\Core\UserRoles\Models\AuditTrailModel;

class AuditTrailService extends BaseModuleService
{
    private AuditTrailModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'audit_trail');
