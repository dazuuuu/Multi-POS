...
use App\Backend\Modules\Core\UserRoles\Models\DeviceManagementModel;

class DeviceManagementService extends BaseModuleService
{
    private DeviceManagementModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'device_management');
        $this->model = new DeviceManagementModel();
    }
