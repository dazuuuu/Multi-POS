...
use App\Backend\Modules\Core\UserRoles\Models\AccountantModel;

class AccountantService extends BaseModuleService
{
    private AccountantModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'accountant');
        $this->model = new AccountantModel();
    }
