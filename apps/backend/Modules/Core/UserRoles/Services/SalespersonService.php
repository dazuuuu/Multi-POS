...
use App\Backend\Modules\Core\UserRoles\Models\SalespersonModel;

class SalespersonService extends BaseModuleService
{
    private SalespersonModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'salesperson');
        $this->model = new SalespersonModel();
    }
