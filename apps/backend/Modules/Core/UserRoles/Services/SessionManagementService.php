...
use App\Backend\Modules\Core\UserRoles\Models\SessionManagementModel;

class SessionManagementService extends BaseModuleService
{
    private SessionManagementModel $model;

    public function __construct()
    {
        parent::__construct('user_roles', 'session_management');
