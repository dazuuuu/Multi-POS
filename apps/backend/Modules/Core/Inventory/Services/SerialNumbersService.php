...
use App\Backend\Modules\Core\Inventory\Models\SerialNumbersModel;

class SerialNumbersService extends BaseModuleService
{
    private SerialNumbersModel $model;

    public function __construct()
    {
        parent::__construct('inventory', 'serial_numbers');
        $this->model = new SerialNumbersModel();
    }
