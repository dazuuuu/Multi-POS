...
use App\Backend\Modules\Core\Inventory\Models\CycleCountsModel;

class CycleCountsService extends BaseModuleService
{
    private CycleCountsModel $model;

    public function __construct()
    {
        parent::__construct('inventory', 'cycle_counts');
        $this->model = new CycleCountsModel();
    }
